...
const schema = yup.object().shape({
    ...
    roomType: yup.string().oneOf(["standard-room", "special-room", "deluxe", "superdeluxe-room"]),
...
export default function AddGuest () {
    ...
    return (
        <main className="min-h-screen flex justify-center px-4 md:px-10 py-12 lg:px-16 py-12">
            <div className="w-full md:w-[350PX] h-auto rounded-md shadow-md px-4">
                ...
                <form className="flex flex-col gap-3 mt-5">
                    ...
                    <button className="text-white w-full rounded-md bg-blue-400 h-8 text-sm font-bold">Book Now</button>
